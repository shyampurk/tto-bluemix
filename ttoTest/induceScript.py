...
'''****************************************************************************************
Function Name 	:	main  (Functional operation)
Description		:	Function which helps to induce the values of our choice for a specific time to specific route
****************************************************************************************'''
...
def main():
	...
	route_time = datetime.datetime.now(pytz.timezone(client_data[route]['timeZone'])) 
	
	diff = recommendedDepTime-route_time
	...
	if (0<=hour <= 12 and 0<=day<=1):
		...
		if (route == 1):
			induceWeather1 = raw_input("\n\t Enter the numeric corresponding to the weather for NEWARK :: ")
			induceWeather2 = raw_input("\n\t Enter the numeric corresponding to the weather for EDISON :: ")
			
			induceTemparature1 = raw_input("\n\t Enter the Temparature NEWARK ::")
			induceTemparature2 = raw_input("\n\t Enter the Temparature EDISON ::")

			newarkedison_doc = {
							"route":"NEWARK-EDISON",
							"induceTime":induceTime,
							"induceWeather":[int(induceWeather1),int(induceWeather2)],
							"induceTemparature":[int(induceTemparature1),int(induceTemparature2)]
							}

			newarkedison_docid = newttobackground.ttoinducecoll.insert_one(newarkedison_doc)

		elif(route == 2):
			induceWeather1 = raw_input("\n\t Enter the numeric corresponding to the weather for BROOKLYN :: ")
			induceWeather2 = raw_input("\n\t Enter the numeric corresponding to the weather for DENVILLE :: ")
			
			induceTemparature1 = raw_input("\n\t Enter the Temparature BROOKLYN ::")
			induceTemparature2 = raw_input("\n\t Enter the Temparature DENVILLE ::")
			...
			induceWeather = raw_input("\n\t Enter the numeric corresponding to the weather for SAN FRANCISCO :: ")
			
			induceTemparature = raw_input("\n\t Enter the Temparature NEWARK SAN FRANCISCO ::")
